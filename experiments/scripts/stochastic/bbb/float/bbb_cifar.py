...
parser.add_argument('--model', type=str, default='conv_resnet_bbb', help='the model that we want to train')
...
parser.add_argument('--gamma', type=float,
                    default=0.01, help='portion of training data')
parser.add_argument('--sigma_prior', type=float,
                    default=.05, help='portion of training data')
...
def main():
  ...
  if not load:
    ...
    train = Trainer(model, criterion, optimizer, scheduler, args, writer)
